    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className="flex items-center gap-1 border-none text-base text-gray-400"
        >
      ...
      <DialogContent className="max-w-[312px] rounded-xl px-0 pt-7 pb-5">
        ...
        <div className="mt-4 flex flex-col">
          <Button
            className="p-3 text-base font-normal text-gray-600"
            variant="ghost"
            onClick={() => {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-1/2 flex -translate-x-1/2 flex-row items-center gap-2 rounded-full bg-gray-900 px-5 py-2"
