...
const TabNavigateBar = () => {
  ...
  return (
    <section className="flex w-full justify-center px-5">
      <div className="fixed bottom-0 z-50 mb-4 inline-flex h-fit w-full justify-evenly rounded-full border border-transparent bg-[#262626] text-center text-white">
